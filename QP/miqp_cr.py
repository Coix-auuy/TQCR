...
class MIQPCRSolver:
    ...
    def write_in_file(self, file):
        ...
        with open("Out/" + file, "a+") as f:
            print("ObjVal: %f, Runtime: %f" %
                  (self.ObjVal, self.Runtime), file=f)


# for i in range(1, 21):
#     s = MIQPCRSolver("../Data/Based8Std/c%d_based_8_std.mod" % i, {"MIPGap": 0, "TimeLimit": 900, "OutputFlag": 0, "Threads": 1})
#     del s

# for i in range(1, 13):
#     s = MIQPCRSolver("../Data/200Unit/200_0_%d_w.mod" % i, {"MIPGap": 0, "TimeLimit": 900, "OutputFlag": 1, "Threads": 1})
#     del s

# s = MIQPCRSolver("../Data/5_std.mod", {"MIPGap": 0, "TimeLimit": 900, "OutputFlag": 1, "Threads": 1})

# s = MIQPCRSolver("../Data/8_std.mod", {"MIPGap": 0, "TimeLimit": 900, "OutputFlag": 1, "Threads": 1})

# s = MIQPCRSolver("../Data/10_0_2_w.mod", {"MIPGap": 0, "TimeLimit": 900, "OutputFlag": 1, "Threads": 1})

# s = MIQPCRSolver("../Data/200Unit/200_0_3_w.mod", {"MIPGap": 0, "TimeLimit": 900, "OutputFlag": 1, "Threads": 1})

# s = MIQPCRSolver("../Data/Based8Std/c13_based_8_std.mod", {"MIPGap": 0, "TimeLimit": 900, "OutputFlag": 1, "Threads": 1})

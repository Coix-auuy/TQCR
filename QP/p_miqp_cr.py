...
def solve(file_path):
    ...
    try:
        ...
        m.setObjective(gp.quicksum(
            alpha[i - 1] * u[i, j] + beta[i - 1] * p[i, j] + gama[i - 1] * (p[i, j] ** 2) + sc[i, j] for i in range(1, unit_num + 1) for j in
...
# solve("../Data/200Unit/200_0_12_w.mod")
# Best objective 5.729793654604e+05, best bound 5.729793654604e+05, gap 0.0000%
# solve("../Data/8_std.mod")
# solve("../Data/200Unit/200_0_1_w.mod")
